...
{
    private readonly FrozenDictionary<int, string> _primitive;
    ...
    private readonly FrozenDictionary<GenericStronglyTypedKey<int>, string> _withGenericStrong;
    private readonly FrozenDictionary<GenericStronglyTypedKey<int>, string> _withGenericStrongWithCustomComparer;
    private readonly FrozenDictionary<ReferenceStronglyTypedInt, string> _withRefStrong;
    private readonly FrozenDictionary<ReferenceStronglyTypedInt, string> _withRefStrongWithCustomComparer;
    private readonly FrozenDictionary<StronglyTypedInt, string> _withStrong;
    private readonly FrozenDictionary<StronglyTypedInt, string> _withStrongWithCustomComparer;
    ...
    public IntImplementation(int n)
    {
        ...
        _primitive = contents.ToFrozenDictionary(x => x, x => x.ToString());
        _withStrong = contents.ToFrozenDictionary(i => new StronglyTypedInt(i), x => x.ToString());
        _withStrongWithCustomComparer =
            contents.ToFrozenDictionary(i => new StronglyTypedInt(i), x => x.ToString(),
                new StronglyTypedKeyEqualityComparerInt());
        _withRefStrong = contents.ToFrozenDictionary(i => new ReferenceStronglyTypedInt(i), x => x.ToString());
        _withRefStrongWithCustomComparer =
            contents.ToFrozenDictionary(i => new ReferenceStronglyTypedInt(i), x => x.ToString(),
                new ReferenceStronglyTypedKeyEqualityComparerInt());
        _withGenericStrong =
            contents.ToFrozenDictionary(x => new GenericStronglyTypedKey<int>(x), x => x.ToString());
...
{
    private readonly FrozenDictionary<Guid, string> _primitive;
    ...
    private readonly FrozenDictionary<GenericStronglyTypedKey<Guid>, string> _withGenericStrong;
    private readonly FrozenDictionary<GenericStronglyTypedKey<Guid>, string> _withGenericStrongWithCustomComparer;
    private readonly FrozenDictionary<ReferenceStronglyTypedGuid, string> _withRefStrong;
    private readonly FrozenDictionary<ReferenceStronglyTypedGuid, string> _withRefStrongWithCustomComparer;
    private readonly FrozenDictionary<StronglyTypedGuid, string> _withStrong;
    private readonly FrozenDictionary<StronglyTypedGuid, string> _withStrongWithCustomComparer;
    ...
    public GuidImplementation(int n)
    {
        ...
        _primitive = contents.ToFrozenDictionary(x => x, x => x.ToString());
        _withStrong = contents.ToFrozenDictionary(i => new StronglyTypedGuid(i), x => x.ToString());
        _withStrongWithCustomComparer =
            contents.ToFrozenDictionary(i => new StronglyTypedGuid(i), x => x.ToString(),
                new StronglyTypedKeyEqualityComparerGuid());
        _withRefStrong = contents.ToFrozenDictionary(i => new ReferenceStronglyTypedGuid(i), x => x.ToString());
        _withRefStrongWithCustomComparer =
            contents.ToFrozenDictionary(i => new ReferenceStronglyTypedGuid(i), x => x.ToString(),
                new ReferenceStronglyTypedKeyEqualityComparerGuid());
        _withGenericStrong =
            contents.ToFrozenDictionary(x => new GenericStronglyTypedKey<Guid>(x), x => x.ToString());
        _withGenericStrongWithCustomComparer =
            contents.ToFrozenDictionary(x => new GenericStronglyTypedKey<Guid>(x), x => x.ToString(),
...
{
    private readonly FrozenDictionary<string, string> _primitive;
    ...
    private readonly FrozenDictionary<GenericStronglyTypedKey<string>, string> _withGenericStrong;
    private readonly FrozenDictionary<GenericStronglyTypedKey<string>, string> _withGenericStrongWithCustomComparer;
    private readonly FrozenDictionary<ReferenceStronglyTypedString, string> _withRefStrong;
    private readonly FrozenDictionary<ReferenceStronglyTypedString, string> _withRefStrongWithCustomComparer;
    private readonly FrozenDictionary<StronglyTypedString, string> _withStrong;
    private readonly FrozenDictionary<StronglyTypedString, string> _withStrongWithCustomComparer;
    ...
    public StringImplementation(int n)
    {
        ...
        _primitive = contents.ToFrozenDictionary(x => x, x => x.ToString());
        _withStrong = contents.ToFrozenDictionary(i => new StronglyTypedString(i), x => x.ToString());
        _withStrongWithCustomComparer =
            contents.ToFrozenDictionary(i => new StronglyTypedString(i), x => x.ToString(),
                new StronglyTypedKeyEqualityComparerString());
        _withRefStrong = contents.ToFrozenDictionary(i => new ReferenceStronglyTypedString(i), x => x.ToString());
        _withRefStrongWithCustomComparer =
            contents.ToFrozenDictionary(i => new ReferenceStronglyTypedString(i), x => x.ToString(),
                new ReferenceStronglyTypedKeyEqualityComparerString());
        _withGenericStrong =
            contents.ToFrozenDictionary(x => new GenericStronglyTypedKey<string>(x), x => x.ToString());
        _withGenericStrongWithCustomComparer =
            contents.ToFrozenDictionary(x => new GenericStronglyTypedKey<string>(x), x => x.ToString(),
